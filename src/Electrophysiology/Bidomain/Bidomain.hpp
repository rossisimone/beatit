...
//    Monodomain( libMesh::MeshBase & mesh );
    ...
    void assemble_matrices(double dt);
   ...
   void evaluate_mesh_size();
    ...
    std::unique_ptr<Exporter> M_bidomainExporter;
    std::set<std::string> M_bidomainExporterNames;
    ...
    std::unique_ptr<EXOExporter> M_bidomainEXOExporter;
