...
#ifndef SRC_ELECTROPHYSIOLOGY_IONICMODELS_Cubic_HPP_
#define SRC_ELECTROPHYSIOLOGY_IONICMODELS_Cubic_HPP_
...
namespace
{
    static bool register_Cubic = IonicModel::IonicModelFactory::Register("cubic", &createCubic );
}
